...
export SDK_PATH="/e/wifi-iot/ESP8266_NONOS_SDK"
export BIN_PATH="/e/wifi-iot/bin"
export PATH=$PATH:"/d/xtensa-lx106-elf-win32-1.22.0-92-g8facf4c-5.2.0\xtensa-lx106-elf\bin"
